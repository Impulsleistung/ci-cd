...
echo "http://$LOAD_BALANCER_IP/aaa (Static Website - Port 8081)"
echo "http://$LOAD_BALANCER_IP/bbb (Gradio Text Converter - Port 8082)"
echo "http://$LOAD_BALANCER_IP/ccc (FastAPI App - Port 8083)"
echo "http://$LOAD_BALANCER_IP/ddd (Docker Firefox - Port 8084)"
echo "http://$LOAD_BALANCER_IP/eee (Sonar App - Port 8085)"
